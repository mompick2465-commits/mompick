-- =====================================================
-- profiles 테이블 auth_user_id 컬럼 추가 및 마이그레이션 (OAuth 포함)
-- =====================================================
...
-- 11. RLS 정책 수정 - auth_user_id를 사용하도록 변경
-- 기존 정책 삭제
...
-- 12. community_posts 테이블의 RLS 정책도 수정
